...
public class ConfigLoader {
	 private final Properties properties;
	    ...
	    private ConfigLoader(){
	        properties = PropertyFile.propertyLoader("src/test/resources/config.properties");
	    }
	    ...
	    public  String getApiKey(){
	        ...
	        else throw new RuntimeException("property ApiKey is not specified in the config.properties file");
	    }
